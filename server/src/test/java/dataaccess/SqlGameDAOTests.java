...
public class SqlGameDAOTests {
    ...
    public void testCreateGameWithValidData() throws DataAccessException {
        GameData gameData = new GameData(1, "whitePlayer", "blackPlayer", "Game1", new ChessGame(), "false");
    ...
    public void testRetrieveGameWithValidID() throws DataAccessException {
        GameData gameData = new GameData(2, "whitePlayer2", "blackPlayer2", "Game2", new ChessGame(), "false");
    ...
    public void testUpdateGameWithValidData() throws DataAccessException {
        GameData gameData = new GameData(3, "whitePlayer3", "blackPlayer3", "Game3", new ChessGame(), "false");
        gameDAO.createGame(3, gameData);
        GameData updatedGameData = new GameData(3, "whitePlayer3Updated", "blackPlayer3Updated", "Game3", new ChessGame(), "false");
    ...
    public void testUpdateGameWithInvalidIDThrowsException() throws DataAccessException {
        GameData gameData = new GameData(999, "whitePlayer", "blackPlayer", "Game", new ChessGame(), "false");
    ...
    public void testDeleteAllGames() throws DataAccessException {
        GameData gameData1 = new GameData(4, "whitePlayer4", "blackPlayer4", "Game4", new ChessGame(), "false");
        GameData gameData2 = new GameData(5, "whitePlayer5", "blackPlayer5", "Game5", new ChessGame(), "false");
